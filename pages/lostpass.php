...
if(Settings::get("mailResetSender") == "")
	Kill(__("The admin hasn't setup any e-mail address for recovering password.<br />This doesn't mean you're locked out forever from the board. You can still contact an admin elsewhere..."));
...
if(isset($_GET['key']) && isset($_GET['id']))
{
	...
	Kill(format(__("Your password has been reset to <strong>{0}</strong>. You can use this password to log in to the board. We suggest you change it as soon as possible. Note that some hosting servers cannot send e-mails"), $newPass), __("Password reset"));
